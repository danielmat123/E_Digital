...
No aplica en este informe, porque solo se reportó una longitud de cuerda. Para construir esta gráfica sería necesario medir el período con al menos cinco longitudes diferentes.
...
**Solución aplicada:**  
Se convirtió el período experimental a segundos dividiendo entre 1,000,000. Luego se comparó el promedio experimental con el valor teórico calculado para una longitud de 0.4 m.
